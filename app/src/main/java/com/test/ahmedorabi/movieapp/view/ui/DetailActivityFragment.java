...
public class DetailActivityFragment extends Fragment implements Injectable {
    ...
    public void onAttach(Context context) {
        ...
        if (!(context instanceof DetailFragmentListener)) throw new AssertionError();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        Glide.with(getActivity()).load(finalUrl).into(binding.fileImage);
        ...
        binding.readMoreImageView.setOnClickListener(v -> mListener.onDetailFragmentFinish(id_movie, type));

        binding.fileImage.setOnClickListener(v -> mListener.DisplayPoster(id_movie, type));
    ...
    public interface DetailFragmentListener {
        ...
        void onDetailActorFinish(int id, String name);

        void onSimilarFragmentFinish(int id, String title, String image, String overview, String release_date, Double vote_average,
                                     String backdrop_path, String language, String type, long voteCount);

        void DisplayImage(String url, String type);

        void DisplayPoster(int id, String type);
    }
    ...
    class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            Glide.with(Objects.requireNonNull(getActivity())).load(finalUrl).into(imageView);
